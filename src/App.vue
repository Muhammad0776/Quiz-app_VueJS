  ...
  <div class="container-app">
        <div class="container-quiz">
          ...
          <div class="footer-quiz">
           ...
           <div class="boxFooter">
          <p>Designed by <a href="https://myuldashoffportfolio.code.blog/">Mukhammad Yuldashev</a></p>
        </div>
        </div>
  </div>
</template>
  ...
  data(){
    return{
      ...
      questions:[
        ...
        {
          question:"Is it true that null == undefined ?",
          propositions:[
            {props:"No"},
        ...
        },
        {
          ...
          propositions:[
            {props:'There is no such operator.'},
            {props:'Compares by reference, not by value.'},
            {props:'Compares without type casting.', correct:true},
        ...
        },
        {
          ...
          propositions:[
            {props:"Any quantity.", correct: true},
            {props:'How much is specified in the function definition, or less.'},
            {props:'How many are specified in the function definition, or more.'},
            {props:'Exactly as many as specified in the function definition.'},
